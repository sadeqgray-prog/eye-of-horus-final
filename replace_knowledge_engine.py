...
"""
🛠 REPLACE KNOWLEDGE ENGINE - جایگزینی کامل فایل مشکل‌دار
"""
...
print(f"{BOLD}{BLUE}🛠 REPLACE KNOWLEDGE ENGINE - FINAL FIX{END}")
print(f"{BOLD}{BLUE}{'='*60}{END}")

# ==================== بک‌آپ ====================
print(f"\n{YELLOW}📦 Creating backup...{END}")
if os.path.exists("brain/knowledge_engine.py"):
    os.system("cp brain/knowledge_engine.py brain/knowledge_engine.py.broken_backup")
    print(f"{GREEN}✅ Backup created: brain/knowledge_engine.py.broken_backup{END}")

# ==================== فایل جدید و سالم ====================
print(f"\n{YELLOW}📝 Creating new clean knowledge_engine.py...{END}")
...
with open("brain/knowledge_engine.py", "w") as f:
    f.write(new_content)

print(f"{GREEN}✅ New knowledge_engine.py created{END}")

# ==================== commit و push ====================
print(f"\n{YELLOW}📦 Committing and pushing...{END}")

os.system("git add brain/knowledge_engine.py")
os.system('git commit -m "FIX: replace knowledge_engine.py with clean version"')
os.system("git push origin main")

print(f"\n{GREEN}{BOLD}{'='*60}{END}")
print(f"{GREEN}{BOLD}✅ FIX COMPLETE - New file pushed{END}")
print(f"{GREEN}{BOLD}{'='*60}{END}")
print(f"\n{BLUE}📋 Summary:{END}")
print(f"  {GREEN}✓{END} Backup created: knowledge_engine.py.broken_backup")
print(f"  {GREEN}✓{END} New clean file created")
print(f"  {GREEN}✓{END} Changes pushed to GitHub")

print(f"\n{YELLOW}⏳ Waiting 2 minutes for Railway to deploy...{END}")
print(f"\n{GREEN}🎉 After 2 minutes, test the bot:{END}")
print(f"  {BLUE}https://t.me/EyeOfHorusProBot{END}")
